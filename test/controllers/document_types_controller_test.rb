...
class DocumentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create document_type" do
    assert_difference('DocumentType.count') do
      post document_types_url, params: { document_type: { codigo: @document_type.codigo, frecuencia: @document_type.frecuencia, nombre: @document_type.nombre, user_id: @document_type.user_id } }
    end
  ...
  test "should update document_type" do
    patch document_type_url(@document_type), params: { document_type: { codigo: @document_type.codigo, frecuencia: @document_type.frecuencia, nombre: @document_type.nombre, user_id: @document_type.user_id } }
